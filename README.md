...
- [ ] Explain what a token is used for.
      A token is used to for secure authentication.
- [ ] What steps can you take in your web apps to keep your data secure?
      Use tokens, and Pprotected routes
- [ ] Describe how web servers work.
      Servers listen for differet request and reply with the appropriate response.
